...
# -*- coding: utf-8 -*-
#
# ipyopenlayers documentation build configuration file
#
...
man_pages = [(master_doc, "ipyopenlayers", "ipyopenlayers Documentation", [author], 1)]
